package cap.stone.bootstrap;

import cap.stone.domain.*;
...
*/
    public void loadProducts(){
        ...
        product1.setProductUrl("http://example.com/product1");
        ...
        product3.setProductUrl("http://example.com/product3");
        productService.saveOrUpdate(product3);

        Product product4 = new Product();
        product4.setDescription("Product 4");
        product4.setPrice(new BigDecimal("44.99"));
        product4.setProductUrl("http://example.com/product4");
        productService.saveOrUpdate(product4);

        Product product5 = new Product();
        product5.setDescription("Product 5");
        product5.setPrice(new BigDecimal("25.99"));
        product5.setProductUrl("http://example.com/product5");
   ...
   /* public void loadCarts(){
        ...
        Cart cart1 = new Cart();
        cart1.setDescription("Cart 1");
        cart1.setPrice(new BigDecimal("12.99"));
        cart1.setProductUrl("http://example.com/product1");
        cartService.saveOrUpdate(cart1);

        Cart cart2 = new Cart();
        cart2.setDescription("Cart 2");
        cart2.setPrice(new BigDecimal("12.99"));
        cart2.setProductUrl("http://example.com/product1");
        cartService.saveOrUpdate(cart2);

        Cart cart3 = new Cart();
        cart3.setDescription("Cart 3");
        cart3.setPrice(new BigDecimal("12.99"));
        cart3.setProductUrl("http://example.com/product1");
        cartService.saveOrUpdate(cart3);

        Cart cart4 = new Cart();
        cart4.setDescription("Cart 4");
        cart4.setPrice(new BigDecimal("12.99"));
        cart4.setProductUrl("http://example.com/product1");
        cartService.saveOrUpdate(cart4);

        Cart cart5 = new Cart();
        cart5.setDescription("Cart 5");
        cart5.setPrice(new BigDecimal("12.99"));
        cart5.setProductUrl("http://example.com/product1");
        cartService.saveOrUpdate(cart5);
